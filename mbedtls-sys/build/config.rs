...
pub const DEFAULT_DEFINES: &'static [CDefine] = &[
    ...
    ("MBEDTLS_NO_PLATFORM_ENTROPY",                       Undefined),
...
#[cfg(not(target_os = "windows"))]
    ("MBEDTLS_THREADING_PTHREAD",                         Defined),
#[cfg(target_os = "windows")]
    ("MBEDTLS_THREADING_WINDOWS",                         Defined),
    ...
    ("MBEDTLS_THREADING_C",                               Defined),
    ("MBEDTLS_TIMING_C",                                  Defined),
